...
pub fn spawn_gold_nugget(entity: Entity, world: &mut World, config: Prefab) -> PrefabBuilder {
    PrefabBuilder::new()
        ...
        .with_description(
            "Heavy with promise and cursed with blood. Every ounce has a ghost attached.",
        )
        .with_item(0.5)
