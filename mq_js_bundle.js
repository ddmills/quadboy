...
function init_webgl(e) {
    if (e == 1) {
        ...
        function n(e) {
            ...
            t && (e.vertexAttribDivisor = function(e, n) {
        ...
        s(gl),
        o(gl),
        gl.getExtension("WEBGL_depth_texture") == null && alert("Cant initialize WEBGL_depth_texture extension")
    } else
...
function UTF8ToString(e, t) {
    ...
    for (var n, a, r, c, s = 0, l = s + t, o = ""; !(s >= l); ) {
        ...
        r = i[s++] & 63,
        (n & 240) == 224 ? n = (n & 15) << 12 | a << 6 | r : ((n & 248) != 240 && console.warn("Invalid UTF-8 leading byte 0x" + n.toString(16) + " encountered when deserializing a UTF-8 string on the asm.js/wasm heap to a JS string!"),
        n = (n & 7) << 18 | a << 12 | r << 6 | i[s++] & 63),
        n < 65536 ? o += String.fromCharCode(n) : (c = n - 65536,
...
function stringToUTF8(e, t, n, s) {
    for (var o, r, c = n, i = n + s, a = 0; a < e.length; ++a)
        if (o = e.charCodeAt(a),
        o >= 55296 && o <= 57343 && (r = e.charCodeAt(++a),
...
GL = {
    ...
    programInfos: {},
    getNewId: function(e) {
        for (var n = GL.counter++, t = e.length; t < n; t++)
            e[t] = null;
        return n
    },
    ...
    getSource: function(e, t, n, s) {
        for (var a, i = "", o = 0; o < t; ++o)
            a = s == 0 ? void 0 : getArray(s + o * 4, Uint32Array, 1)[0],
            i += UTF8ToString(getArray(n + o * 4, Uint32Array, 1)[0], a);
        return i
    },
    populateUniformTable: function(e) {
        GL.validateGLObjectID(GL.programs, e, "populateUniformTable", "program");
        for (var t, n, s, i, a, l, o = GL.programs[e], r = GL.programInfos[e] = {
            uniforms: {},
            maxUniformLength: 0,
            maxAttributeLength: -1,
            maxUniformBlockNameLength: -1
        }, d = r.uniforms, u = gl.getProgramParameter(o, 35718), c = 0; c < u; ++c)
            if (i = gl.getActiveUniform(o, c),
            t = i.name,
            r.maxUniformLength = Math.max(r.maxUniformLength, t.length + 1),
            t.slice(-1) == "]" && (t = t.slice(0, t.lastIndexOf("["))),
            n = gl.getUniformLocation(o, t),
            n) {
                s = GL.getNewId(GL.uniforms),
                d[t] = [i.size, s],
                GL.uniforms[s] = n;
                for (a = 1; a < i.size; ++a)
                    l = t + "[" + a + "]",
                    n = gl.getUniformLocation(o, l),
                    s = GL.getNewId(GL.uniforms),
                    GL.uniforms[s] = n
            }
    }
...
function _glGenObject(e, t, n, s, o) {
    for (var i, a, r = 0; r < e; r++)
        ...
        a = i && GL.getNewId(s),
        i ? (i.name = a,
        s[a] = i) : (console.error("GL_INVALID_OPERATION"),
        GL.recordError(1282),
        alert("GL_INVALID_OPERATION in " + o + ": GLctx." + n + " returned null - most likely GL context is lost!")),
...
function _webglGet(e, t, n) {
    ...
    case 36346:
        ...
        break;
    case 36344:
        n != "EM_FUNC_SIG_PARAM_I" && n != "EM_FUNC_SIG_PARAM_I64" && (GL.recordError(1280),
        err("GL_INVALID_ENUM in glGet" + n + "v(GL_SHADER_BINARY_FORMATS): Invalid parameter type!"));
        return;
    case 34814:
    case 36345:
        o = 0;
    ...
    if (o === void 0)
        ...
        case "string":
            GL.recordError(1280),
            console.error("GL_INVALID_ENUM in glGet" + n + "v(" + e + ") on a name which returns a string!");
            return;
        case "object":
            if (s === null)
                switch (e) {
                ...
                default:
                    {
                        GL.recordError(1280),
                        console.error("GL_INVALID_ENUM in glGet" + n + "v(" + e + ") and it returns null!");
                        return
                    }
                }
                ...
                try {
                    ...
                    GL.recordError(1280),
                    console.error("GL_INVALID_ENUM in glGet" + n + "v: Unknown object returned from WebGL getParameter(" + e + ")! (error: " + t + ")");
                    return
                }
            break;
        default:
            GL.recordError(1280),
            console.error("GL_INVALID_ENUM in glGet" + n + "v: Native code calling glGet" + n + "v(" + e + ") and it returns " + s + " of type " + typeof s + "!");
            return
        }
    switch (n) {
...
function resize(e, t) {
    var o = dpi_scale()
      , n = e.clientWidth * o
      , s = e.clientHeight * o;
    (e.width != n || e.height != s) && (e.width = n,
    e.height = s,
    t != null && t(Math.floor(n), Math.floor(s)))
}
function animation() {
    wasm_exports.frame(),
    window.blocking_event_loop || (animation_frame_timeout && window.cancelAnimationFrame(animation_frame_timeout),
...
importObject = {
    env: {
        ...
        glBindTexture: function(e, t) {
            GL.validateGLObjectID(GL.textures, t, "glBindTexture", "texture"),
            gl.bindTexture(e, GL.textures[t])
        },
        ...
        glUniform1fv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform1fv", "location"),
            assert((n & 3) == 0, "Pointer to float data passed to glUniform1fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 1 * t);
            gl.uniform1fv(GL.uniforms[e], s)
        },
        glUniform2fv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform2fv", "location"),
            assert((n & 3) == 0, "Pointer to float data passed to glUniform2fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 2 * t);
            gl.uniform2fv(GL.uniforms[e], s)
        },
        glUniform3fv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform3fv", "location"),
            assert((n & 3) == 0, "Pointer to float data passed to glUniform3fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 3 * t);
            gl.uniform3fv(GL.uniforms[e], s)
        },
        glUniform4fv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform4fv", "location"),
            assert((n & 3) == 0, "Pointer to float data passed to glUniform4fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 4 * t);
            gl.uniform4fv(GL.uniforms[e], s)
        },
        glUniform1iv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform1fv", "location"),
            assert((n & 3) == 0, "Pointer to i32 data passed to glUniform1iv must be aligned to four bytes!");
            var s = getArray(n, Int32Array, 1 * t);
            gl.uniform1iv(GL.uniforms[e], s)
        },
        glUniform2iv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform2fv", "location"),
            assert((n & 3) == 0, "Pointer to i32 data passed to glUniform2iv must be aligned to four bytes!");
            var s = getArray(n, Int32Array, 2 * t);
            gl.uniform2iv(GL.uniforms[e], s)
        },
        glUniform3iv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform3fv", "location"),
            assert((n & 3) == 0, "Pointer to i32 data passed to glUniform3iv must be aligned to four bytes!");
            var s = getArray(n, Int32Array, 3 * t);
            gl.uniform3iv(GL.uniforms[e], s)
        },
        glUniform4iv: function(e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform4fv", "location"),
            assert((n & 3) == 0, "Pointer to i32 data passed to glUniform4iv must be aligned to four bytes!");
        ...
        glUniform1f: function(e, t) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform1f", "location"),
            gl.uniform1f(GL.uniforms[e], t)
        },
        glUniform1i: function(e, t) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform1i", "location"),
            gl.uniform1i(GL.uniforms[e], t)
        },
        ...
        glGetUniformLocation: function(e, t) {
            GL.validateGLObjectID(GL.programs, e, "glGetUniformLocation", "program"),
            t = UTF8ToString(t);
            var s, o, n = 0;
            return t[t.length - 1] == "]" && (s = t.lastIndexOf("["),
            n = t[s + 1] != "]" ? parseInt(t.slice(s + 1)) : 0,
            t = t.slice(0, s)),
            o = GL.programInfos[e] && GL.programInfos[e].uniforms[t],
            o && n >= 0 && n < o[0] ? o[1] + n : -1
        },
        glUniformMatrix4fv: function(e, t, n, s) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniformMatrix4fv", "location"),
            assert((s & 3) == 0, "Pointer to float data passed to glUniformMatrix4fv must be aligned to four bytes!");
            var o = getArray(s, Float32Array, 16);
            gl.uniformMatrix4fv(GL.uniforms[e], !!n, o)
        },
        glUseProgram: function(e) {
            GL.validateGLObjectID(GL.programs, e, "glUseProgram", "program"),
            gl.useProgram(GL.programs[e])
        },
        ...
        glBindFramebuffer: function(e, t) {
            GL.validateGLObjectID(GL.framebuffers, t, "glBindFramebuffer", "framebuffer"),
            gl.bindFramebuffer(e, GL.framebuffers[t])
        },
        glCheckFramebufferStatus: function(e) {
            return gl.checkFramebufferStatus(e)
        },
        glBindRenderbuffer: function(e, t) {
            GL.validateGLObjectID(GL.renderbuffers, t, "glBindRenderbuffer", "renderbuffer"),
            gl.bindRenderbuffer(e, GL.renderbuffers[t])
        },
        glGenBuffers: function(e, t) {
            _glGenObject(e, t, "createBuffer", GL.buffers, "glGenBuffers")
        },
        glBindBuffer: function(e, t) {
            GL.validateGLObjectID(GL.buffers, t, "glBindBuffer", "buffer"),
            gl.bindBuffer(e, GL.buffers[t])
        },
        ...
        glAttachShader: function(e, t) {
            GL.validateGLObjectID(GL.programs, e, "glAttachShader", "program"),
            GL.validateGLObjectID(GL.shaders, t, "glAttachShader", "shader"),
            gl.attachShader(GL.programs[e], GL.shaders[t])
        },
        glDetachShader: function(e, t) {
            GL.validateGLObjectID(GL.programs, e, "glDetachShader", "program"),
            GL.validateGLObjectID(GL.shaders, t, "glDetachShader", "shader"),
            gl.detachShader(GL.programs[e], GL.shaders[t])
        },
        glLinkProgram: function(e) {
            GL.validateGLObjectID(GL.programs, e, "glLinkProgram", "program"),
            gl.linkProgram(GL.programs[e]),
        ...
        glFramebufferTexture2D: function(e, t, n, s, o) {
            GL.validateGLObjectID(GL.textures, s, "glFramebufferTexture2D", "texture"),
            gl.framebufferTexture2D(e, t, n, GL.textures[s], o)
        },
        glReadBuffer: function(e) {
            if (gl.readBuffer) {
                gl.readBuffer(e)
            } else {
                console.warn("glReadBuffer not available in WebGL1")
            }
        },
        glBlitFramebuffer: function(e, t, n, s, o, i, a, r, c, l) {
            if (gl.blitFramebuffer) {
                gl.blitFramebuffer(e, t, n, s, o, i, a, r, c, l)
            } else {
                console.warn("glBlitFramebuffer not available in WebGL1")
            }
        },
        glGetProgramiv: function(e, t, n) {
            if (assert(n),
            GL.validateGLObjectID(GL.programs, e, "glGetProgramiv", "program"),
            e >= GL.counter) {
                console.error("GL_INVALID_VALUE in glGetProgramiv");
                return
            }
            var s, o = GL.programInfos[e];
            if (!o) {
            ...
            if (t == 35716)
                s = gl.getProgramInfoLog(GL.programs[e]),
                assert(s !== null),
                getArray(n, Int32Array, 1)[0] = s.length + 1;
            else if (t == 35719) {
                ...
                getArray(n, Int32Array, 1)[0] = gl.getProgramParameter(GL.programs[e], t)
        },
        glCreateShader: function(e) {
            var t = GL.getNewId(GL.shaders);
            return GL.shaders[t] = gl.createShader(e),
            t
        },
        ...
        glShaderSource: function(e, t, n, s) {
            ...
            var i, o = GL.getSource(e, t, n, s);
            emscripten_shaders_hack && (o = o.replace(/#extension GL_OES_standard_derivatives : enable/g, ""),
            o = o.replace(/#extension GL_EXT_shader_texture_lod : enable/g, ""),
            i = "",
            o.indexOf("gl_FragColor") != -1 && (i += `out mediump vec4 GL_FragColor;
`,
            o = o.replace(/gl_FragColor/g, "GL_FragColor")),
            o.indexOf("attribute") != -1 ? (o = o.replace(/attribute/g, "in"),
            o = o.replace(/varying/g, "out")) : o = o.replace(/varying/g, "in"),
            ...
            o = o.replace(/#version 100/g, `#version 300 es
` + i)),
        ...
        glGetProgramInfoLog: function(e, t, n, s) {
            ...
            var o, i = gl.getProgramInfoLog(GL.programs[e]);
            assert(i !== null);
        ...
        glGetString: function(e) {
            ...
            return o[t.length] = 0,
            stringToUTF8(t, o, 0, n),
            s
        },
        glCompileShader: function(e) {
            GL.validateGLObjectID(GL.shaders, e, "glCompileShader", "shader"),
            gl.compileShader(GL.shaders[e])
        },
        glGetShaderiv: function(e, t, n) {
            if (assert(n),
            GL.validateGLObjectID(GL.shaders, e, "glGetShaderiv", "shader"),
            t == 35716) {
                var s, i, o = gl.getShaderInfoLog(GL.shaders[e]);
                assert(o !== null),
                getArray(n, Int32Array, 1)[0] = o.length + 1
            } else
                t == 35720 ? (s = gl.getShaderSource(GL.shaders[e]),
                i = s === null || s.length == 0 ? 0 : s.length + 1,
                getArray(n, Int32Array, 1)[0] = i) : getArray(n, Int32Array, 1)[0] = gl.getShaderParameter(GL.shaders[e], t)
        },
        glGetShaderInfoLog: function(e, t, n, s) {
            GL.validateGLObjectID(GL.shaders, e, "glGetShaderInfoLog", "shader");
            var o, i = gl.getShaderInfoLog(GL.shaders[e]);
            assert(i !== null);
            let a = getArray(s, Uint8Array, t);
            for (o = 0; o < t; o++)
                a[o] = i.charCodeAt(o)
        ...
        glDeleteBuffers: function(e, t) {
            for (var n, o, s = 0; s < e; s++) {
                if (o = getArray(t + s * 4, Uint32Array, 1)[0],
                n = GL.buffers[o],
                !n)
                    continue;
                gl.deleteBuffer(n),
        ...
        glDeleteQueries: function(e) {
            for (var n, o, s = 0; s < e; s++) {
                if (o = getArray(textures + s * 4, Uint32Array, 1)[0],
                n = GL.timerQueries[o],
                !n)
                    continue;
                gl.deleteQuery(n),
                n.name = 0,
                GL.timerQueries[o] = null
            }
        },
        glBeginQuery: function(e, t) {
            GL.validateGLObjectID(GL.timerQueries, t, "glBeginQuery", "id"),
            gl.beginQuery(e, GL.timerQueries[t])
        },
        ...
        run_animation_loop: function(e) {
            canvas.onmousemove = function(e) {
                var t = mouse_relative_position(e.clientX, e.clientY)
                  , n = t.x
                  , s = t.y;
                wasm_exports.mouse_move(Math.floor(n), Math.floor(s)),
                (e.movementX != 0 || e.movementY != 0) && wasm_exports.raw_mouse_move(Math.floor(e.movementX), Math.floor(e.movementY))
            }
            ,
            ...
            canvas.addEventListener("wheel", function(e) {
                e.preventDefault(),
                wasm_exports.mouse_wheel(-e.deltaX, -e.deltaY)
            }),
            ...
            canvas.onkeydown = function(e) {
                var n, t = into_sapp_keycode(e.code);
                switch (t) {
                case 32:
                case 262:
                case 263:
            ...
            canvas.onkeyup = function(e) {
                var n = into_sapp_keycode(e.code)
                  , t = 0;
                e.ctrlKey && (t |= SAPP_MODIFIER_CTRL),
                e.shiftKey && (t |= SAPP_MODIFIER_SHIFT),
                e.altKey && (t |= SAPP_MODIFIER_ALT),
                wasm_exports.key_up(n, t)
            }
            ,
            ...
            canvas.addEventListener("touchstart", function(e) {
                ...
                for (const t of e.changedTouches) {
                    let n = mouse_relative_position(t.clientX, t.clientY);
            ...
            window.addEventListener("copy", function() {
                clipboard != null && (event.clipboardData.setData("text/plain", clipboard),
            ...
            window.addEventListener("paste", function(e) {
                e.stopPropagation(),
                e.preventDefault();
                var n, s, o, i = e.clipboardData || window.clipboardData, t = i.getData("Text");
                t != null && t.length != 0 && (n = (new TextEncoder).encode(t).length,
                s = wasm_exports.allocate_vec_u8(n),
                o = new Uint8Array(wasm_memory.buffer,s,n),
                stringToUTF8(t, o, 0, n),
                wasm_exports.on_clipboard_paste(s, n))
            }),
            ...
            window.ondrop = async function(e) {
                ...
                for (let n of e.dataTransfer.files) {
                    ...
                    c.set(new Uint8Array(i), 0),
                    wasm_exports.on_file_dropped(o, t, a, s)
                }
            ...
            var t = function() {
                ...
                n == e && (wasm_exports.focus(e),
                n = e)
            };
            document.addEventListener("visibilitychange", t),
            window.addEventListener("focus", t),
            window.addEventListener("blur", t),
            window.blocking_event_loop = e,
            window.requestAnimationFrame(animation)
        },
        fs_load_file: function(e, t) {
            var s, o = UTF8ToString(e, t), n = FS.unique_id;
            return FS.unique_id += 1,
            ...
            s.onreadystatechange = function() {
                if (this.readyState === 4)
                    if (this.status === 200) {
                        ...
                        FS.loaded_files[n] = e,
                        wasm_exports.file_loaded(n)
                    } else
                        FS.loaded_files[n] = null,
                        wasm_exports.file_loaded(n)
            }
            ,
            s.send(),
        ...
        fs_take_buffer: function(e, t, n) {
            var s, i, o = FS.loaded_files[e];
            console.assert(o.length <= n),
            i = new Uint8Array(wasm_memory.buffer,t,n);
        ...
        sapp_schedule_update: function() {
            animation_frame_timeout && window.cancelAnimationFrame(animation_frame_timeout),
            animation_frame_timeout = window.requestAnimationFrame(animation)
        },
        init_webgl
    }
...
function register_plugins(e) {
    ...
    for (var t = 0; t < e.length; t++)
        e[t].register_plugin != void 0 && e[t].register_plugin != null && e[t].register_plugin(importObject)
}
function init_plugins(e) {
    ...
    for (var n, s, t = 0; t < e.length; t++)
        ...
        e[t].name == void 0 || e[t].name == null || e[t].version == void 0 || e[t].version == null ? (console.warn("Some of the registred plugins do not have name or version"),
        console.warn("Probably old version of the plugin used")) : (n = e[t].name + "_crate_version",
        wasm_exports[n] == void 0 ? console.log("Plugin " + e[t].name + " is present in JS bundle, but is not used in the rust code.") : (s = wasm_exports[n](),
        e[t].version != s && console.error("Plugin " + e[t].name + " version mismatchjs version: " + e[t].version + ", crate version: " + s)))
}
...
function add_missing_functions_stabs(e) {
    ...
    for (const e in t)
        importObject.env[t[e].name] == void 0 && (console.warn("No " + t[e].name + " function in gl.js"),
...
function load(e) {
    ...
    typeof WebAssembly.compileStreaming == "function" ? WebAssembly.compileStreaming(t).then(e => (add_missing_functions_stabs(e),
    WebAssembly.instantiate(e, importObject))).then(e => {
        wasm_memory = e.exports.memory,
        wasm_exports = e.exports;
        var t = wasm_exports.crate_version();
        version != t && console.error("Version mismatch: gl.js version is: " + version + ", miniquad crate version is: " + t),
        ...
        return add_missing_functions_stabs(e),
        WebAssembly.instantiate(e, importObject)
    }).then(function(e) {
        wasm_memory = e.exports.memory,
        wasm_exports = e.exports;
        var t = wasm_exports.crate_version();
        version != t && console.error("Version mismatch: gl.js version is: " + version + ", rust sapp-wasm crate version is: " + t),
        init_plugins(plugins),
        e.exports.main()
    }).catch(e => {
...
(function() {
        ...
        if (e == null) {
            ...
            let n = e.listener;
            {
                ...
                var t = function() {
                    ...
                    o.start ? o.start(0) : o.play ? o.play(0) : o.noteOn && o.noteOn(0),
    ...
    function r(t, s) {
        let a = wasm_memory.buffer.slice(t, t + s)
          , i = o;
        return o += 1,
        e.decodeAudioData(a, function(e) {
            n.set(i, e)
        }, function(e) {
    ...
    function a(e) {
        return n.has(e) && n.get(e) != void 0
    }
    function l() {
        let n = t.find(e => e.sound_key === 0);
        return n != null ? n.source = e.createBufferSource() : (n = {
            sound_key: 0,
            playback_key: 0,
            source: e.createBufferSource(),
            gain_node: e.createGain(),
            ended: null
        },
        t.push(n)),
        n
    ...
    function s(e) {
        try {
            e.source.removeEventListener("ended", e.ended),
            e.source.disconnect(),
            e.gain_node.disconnect(),
            e.sound_key = 0,
            e.playback_key = 0
        } catch (e) {
    ...
    function u(t, o, i) {
        ...
        a.sound_key = t,
        a.playback_key = r,
        a.source.connect(a.gain_node),
        a.gain_node.connect(e.destination),
        a.gain_node.gain.value = o,
        a.source.loop = i,
        a.ended = function() {
            s(a)
        }
        ,
        a.source.addEventListener("ended", a.ended);
        try {
            a.source.buffer = n.get(t),
            a.source.start(0)
        } catch (e) {
    ...
    function h(e, n) {
        t.forEach(t => {
            t.sound_key === e && (t.gain_node.gain.value = n)
        }
        )
    }
    function i(e) {
    ...
    function p(e) {
        let n = t.find(t => t.playback_key === e);
        n != null && s(n)
    }
    function g(e, n) {
        let s = t.find(t => t.playback_key === e);
        s != null && (s.gain_node.gain.value = n)
    }
    function v(e) {
        e.env.audio_init = d,
        e.env.audio_add_buffer = r,
        e.env.audio_play_buffer = u,
        e.env.audio_source_is_loaded = a,
        e.env.audio_source_set_volume = h,
        e.env.audio_source_stop = i,
        e.env.audio_source_delete = f,
        e.env.audio_playback_stop = p,
        e.env.audio_playback_set_volume = g
    }
    miniquad_add_plugin({
        register_plugin: v,
        version: 1,
        name: "macroquad_audio"
    })
}
)(),
function() {
    ...
    n = 0;
    function o(n) {
        n.env.js_create_string = function(e, n) {
            var s = UTF8ToString(e, n);
            return t(s)
        }
        ,
        n.env.js_create_buffer = function(e, n) {
            var s = new Uint8Array(wasm_memory.buffer,e,n)
              , o = new Uint8Array(new ArrayBuffer(s.byteLength));
            return o.set(new Uint8Array(s)),
            t(o)
        }
        ,
        n.env.js_create_object = function() {
            var e = {};
            return t(e)
        }
        ,
        n.env.js_set_field_f32 = function(t, n, s, o) {
            var i = UTF8ToString(n, s);
            e[t][i] = o
        }
        ,
        n.env.js_set_field_u32 = function(t, n, s, o) {
            var i = UTF8ToString(n, s);
            e[t][i] = o
        }
        ,
        n.env.js_set_field_string = function(t, n, s, o, i) {
            var a = UTF8ToString(n, s)
              , r = UTF8ToString(o, i);
            e[t][a] = r
        }
        ,
        n.env.js_unwrap_to_str = function(t, n, o) {
            for (var r = e[t], a = s(r), c = a.length, l = new Uint8Array(wasm_memory.buffer,n,o), i = 0; i < c; i++)
                l[i] = a[i]
        }
        ,
        n.env.js_unwrap_to_buf = function(t, n, s) {
            for (var i = e[t], a = i.length, r = new Uint8Array(wasm_memory.buffer,n,s), o = 0; o < a; o++)
                r[o] = i[o]
        }
        ,
        n.env.js_string_length = function(t) {
            var n = e[t];
            return s(n).length
        }
        ,
        n.env.js_buf_length = function(t) {
            var n = e[t];
            return n.length
        }
        ,
        n.env.js_free_object = function(t) {
            delete e[t]
        }
        ,
        n.env.js_have_field = function(t, n, s) {
            var o = UTF8ToString(n, s);
            return e[t][o] !== void 0
        }
        ,
        n.env.js_field_f32 = function(t, n, s) {
            var o = UTF8ToString(n, s);
            return e[t][o]
        }
        ,
        n.env.js_field_u32 = function(t, n, s) {
            var o = UTF8ToString(n, s);
            return e[t][o]
        }
        ,
        n.env.js_field = function(n, s, o) {
            var i = UTF8ToString(s, o)
              , a = e[n][i];
            return t(a)
        }
        ,
        n.env.js_field_num = function(t, n, s) {
            var o = UTF8ToString(n, s);
            return e[t][o]
        }
    }
    ...
    function s(e) {
        for (var t, n = [], s = 0; s < e.length; s++)
            t = e.charCodeAt(s),
            t < 128 ? n.push(t) : t < 2048 ? n.push(192 | t >> 6, 128 | t & 63) : t < 55296 || t >= 57344 ? n.push(224 | t >> 12, 128 | t >> 6 & 63, 128 | t & 63) : (s++,
            t = 65536 + ((t & 1023) << 10 | e.charCodeAt(s) & 1023),
            n.push(240 | t >> 18, 128 | t >> 12 & 63, 128 | t >> 6 & 63, 128 | t & 63));
        return n
    }
    function t(t) {
        if (t == null)
...
function() {
    ...
    function d(e) {
        e.env.ws_connect = a,
        e.env.ws_is_connected = i,
        e.env.ws_send = r,
        e.env.ws_try_recv = c,
        e.env.http_make_request = h,
        e.env.http_try_recv = u
    }
    miniquad_add_plugin({
        register_plugin: d,
        on_init: l,
    ...
    function a(e) {
        t = new WebSocket(consume_js_object(e)),
    ...
    function r(e) {
        var n = consume_js_object(e);
        n.buffer != void 0 ? t.send(n.buffer) : t.send(n)
    }
    function c() {
        return n.length != 0 ? js_object(n.shift()) : -1
    }
    s = 0,
    e = {};
    function u(t) {
    ...
    function h(t, n, o, i) {
        ...
        t == 2 && (r = "GET"),
        t == 3 && (r = "DELETE"),
        d = consume_js_object(n),
        u = consume_js_object(o),
        c = consume_js_object(i),
